    ...
    //console.log("C- Output XML - Line 958", fatcaresult2[0].return_msg._text)
      ...
      if(fatcaresult==0){    
        agmess= {
           status:200,
           message:'Successfull',            
           data:  { "Unique_No ": ashdata1,"Trxn_No: ": ashdata2 ,"Application_No: ": ashdata3, "Fund: ": ashdata4,"Scheme: ": ashdata5, "Scheme_Name: ": ashdata6, "Amt: ": ashdata7,"Status_Desc ":"","Status_code ":"","Input_ref_no ":"","Paymentlink ":fatcaresult2.Paymentlink._text.substring(9,(fatcaresult2.Paymentlink._text.length+3)*.5),},  
           message_full: fatcaresult2 ,
         }
       }else{
         agmess= {
